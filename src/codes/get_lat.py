...
###################################################################################################################################
# Get the latitudinal and longitudinal position of the MBTA trains. This position is used to mark the trains on the map
# Authors: Anmol Gupta, Aravind Sridhar
# Boston University
###################################################################################################################################
